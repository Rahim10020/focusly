/**
 * @fileoverview Landing page component for unauthenticated users.
 */
  ...
  const featureCards = [
    {
      ...
      description: 'Stay focused with customizable 25-minute work sessions followed by refreshing breaks.',
      icon: (
    ...
    },
    {
      ...
      description: 'Organize tasks by priority, add sub-tasks, and track your progress with detailed insights.',
      icon: (
    ...
    },
    {
      ...
      description: 'Build streaks, unlock achievements, and compete with friends on the leaderboard.',
      icon: (
    ...
    },
    {
      ...
      description: 'Plot tasks on a monthly calendar, see start times, and export your schedule to iCal.',
      icon: (
        <svg className="w-6 h-6 text-brand-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: 'Unlock charts, streak insights, and one-click CSV/PDF exports from the dashboard.',
      icon: (
        <svg className="w-6 h-6 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: 'Add friends, accept requests, and climb global rankings for tasks, focus time, or streaks.',
      icon: (
        <svg className="w-6 h-6 text-brand-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: 'Get alerted for overdue tasks, due-today reminders, and completed Pomodoros in real-time.',
      icon: (
        <svg className="w-6 h-6 text-brand-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
