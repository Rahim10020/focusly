...
function TaskModalContent({
    ...
    const [selectedSubDomain, setSelectedSubDomain] = useState<SubDomain | undefined>(() => initialData?.subDomain);
    const [subTasks, setSubTasks] = useState<{ title: string; completed: boolean }[]>(() => initialData?.subTasks || []);
