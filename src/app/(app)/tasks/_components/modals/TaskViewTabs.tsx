...
export default function TaskModalTabs({
  ...
  return (
    <div className="sticky top-[89px] bg-card border-b border-border px-6 py-4 z-10">
      <div className="flex">
        {tabs.map((tab) => (
          <button
            key={tab.id}
            ...
            className={`flex-1 cursor-pointer flex items-center gap-2 text-base font-medium transition-all ${
              activeTab === tab.id
                ? "text-primary"
