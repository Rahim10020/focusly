  ...
  if (!isExpanded) {
    return (
      <button
        ...
        className="w-full group flex items-center gap-3 p-4 rounded-xl border-2 border-dashed border-border hover:border-primary/40 hover:bg-surface-subtle transition-all text-left cursor-pointer"
      >
    ...
    <div className="p-4 rounded-xl border-2 border-primary/30 bg-card shadow-md space-y-3 animate-scale-in">
      ...
      <div className="flex items-center justify-between gap-3">
        <div className="flex items-center gap-2 text-xs text-muted-foreground">
          ...
          <span>to save</span>
          <kbd className="px-2 py-1 bg-muted rounded text-xs font-mono ml-2">
            Esc
          </kbd>
          <span>to cancel</span>
        </div>
